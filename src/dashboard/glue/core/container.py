"""
GlueContainer — dependency container for the glue dispensing application.
"""
...
class GlueContainer:
    ...
    def get_cell_capacity(self, cell_id: int) -> float:
        ...
        try:
            ...
            response = self.controller_service.send_request(glue_endpoints.GLUE_CELLS_CONFIG_GET)
